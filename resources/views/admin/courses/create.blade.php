        ...
        <div class="card-body">
            <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <input name="hours" type="text" class="form-control" id="title" aria-describedby="hours" value="">
                    @error('hours')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input name="price" type="text" class="form-control" id="title" aria-describedby="price" value="">
                    @error('price')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mt-3 form-check">
                    <input name="gst" type="checkbox" class="form-check-input" id="exampleCheck1" checked>
                    <label class="form-check-label" for="exampleCheck1">GST Applicable</label>
                </div>

                <div class="mt-3">
                    <label for="students" class="form-label">Students</label>
                    <input name="students" type="number" class="form-control" id="title" aria-describedby="students" value="">
                    @error('students')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
