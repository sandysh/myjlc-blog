...
@section('content')
    <div class="container p-4" style="max-width: 768px;">
        ...
        <p class="text-center" id="title-company-name">My Java Learning Center</p>
        <hr>
        ...
        <p>
            ...
            <li><strong>Company </strong>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to <span id="company-name">My Java Learning Center</span>.</li>
        ...
        <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.
            ...
            <br><br>This Privacy Policy was last updated on <span id="gen-at">2023/09/21 06:06:10</span>
        </p>


        <h2 class="text-center">Contact Us</h2>
        If you have any questions about this Privacy Policy, You can contact us via email at <span id="email">myjlc@myjavalearningcenter.com</span>
        <hr>
